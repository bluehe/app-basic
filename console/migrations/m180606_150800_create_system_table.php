...
//            [406, 4, 'sms_captcha', '验证码模板', 'text', '', '', '', 6],
            ...
            [414, 4, 'aliyun_sms_captcha', '验证码模板', 'text', '', '', '', 6],
            [421, 4, 'cloudsmser_sms_key', 'Key', 'text', '', '', '', 3],
            [422, 4, 'cloudsmser_sms_secret', 'Secret', 'password', '', '', '', 4],
            [423, 4, 'cloudsmser_sms_captcha', '验证码模板', 'text', '', '', '', 5],
            [431, 4, 'submail_sms_key', 'APPID', 'text', '', '', '', 3],
...
//            [508, 5, 'cdn_host', 'host', 'text', '', '', '', 8],
            ...
            [515, 5, 'Alioss_cdn_bucket', 'Bucket 名称', 'text', '', '', '', 7],
            [516, 5, 'Alioss_cdn_host', '用户域名', 'text', '', '', '', 8],
            [522, 5, 'Qiniu_cdn_key', 'accessKey', 'text', '', '', '', 4],
            [523, 5, 'Qiniu_cdn_secret', 'secretKey', 'password', '', '', '', 5],
            [525, 5, 'Qiniu_cdn_bucket', 'bucket', 'text', '', '', '', 7],
            [526, 5, 'Qiniu_cdn_host', 'host', 'text', '', '', '', 8],
            [531, 5, 'Qcloud_cdn_appid', 'appId', 'text', '', '', '', 3],
            [532, 5, 'Qcloud_cdn_key', 'secretId', 'text', '', '', '', 4],
            [533, 5, 'Qcloud_cdn_secret', 'secretKey', 'password', '', '', '', 5],
            [534, 5, 'Qcloud_cdn_point', 'region', 'text', '', '', '', 6],
            [535, 5, 'Qcloud_cdn_bucket', 'bucket', 'text', '', '', '', 7],
            [536, 5, 'Qcloud_cdn_host', 'host', 'text', '', '', '', 8],
            [542, 5, 'Netease_cdn_key', 'accessKey', 'text', '', '', '', 4],
            [543, 5, 'Netease_cdn_secret', 'accessSecret', 'password', '', '', '', 5],

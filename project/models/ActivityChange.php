...
{   
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_act' => '活跃',
            'act_trend' => '趋势',
            'projectman_usercount' => '项目用户数(A)',
            'projectman_projectcount' => '当前项目数(A)',
            'projectman_membercount' => '当前项目成员数(A)',
            'projectman_versioncount' => '当前迭代数(A)',
            'projectman_issuecount' => '工作项数(A)',
            'projectman_storagecount' => '项目存储空间(A)',
            'codehub_all_usercount' => '配置管理用户数(A)',
            'codehub_repositorycount' => '当前代码仓库数(A)',
            'codehub_commitcount' => '提交次数(A)',
            'codehub_repositorysize' => '存储空间(A)',
            'pipeline_usercount' => '流水线用户数(A)',
            'pipeline_pipecount' => '当前流水线条数(A)',
            'pipeline_executecount' => '流水线执行次数(A)',
            'pipeline_elapse_time' => '流水线执行时长(A)',
            'codecheck_usercount' => '代码检查用户数(A)',
            'codecheck_taskcount' => '当前检查任务数(A)',
            'codecheck_codelinecount' => '检查代码行数(A)',
            'codecheck_issuecount' => '检查发现问题总数(A)',
            'codecheck_execount' => '检查次数(A)',
            'codeci_usercount' => '编译构建用户数(A)',
            'codeci_buildcount' => '当前构建任务数(A)',
            'codeci_allbuildcount' => '构建次数(A)',
            'codeci_buildtotaltime' => '构建时长(A)',
            'testman_usercount' => '测试管理用户数(A)',
            'testman_casecount' => '用例总数(A)',
            'testman_totalexecasecount' => '用例执行次数(A)',
            'deploy_usercount' => '部署用户数(A)',
            'deploy_envcount' => '当前部署任务数(A)',
            'deploy_execount' => '部署次数(A)',
            'deploy_vmcount' => '节点数(A)',
            'projectman_usercount_d' => '项目用户数',
            'projectman_projectcount_d' => '当前项目数',
            'projectman_membercount_d' => '当前项目成员数',
            'projectman_versioncount_d' => '当前迭代数',
            'projectman_issuecount_d' => '工作项数',
            'projectman_storagecount_d' => '项目存储空间',
            'codehub_all_usercount_d' => '配置管理用户数',
            'codehub_repositorycount_d' => '当前代码仓库数',
            'codehub_commitcount_d' => '提交次数',
            'codehub_repositorysize_d' => '存储空间',
            'pipeline_usercount_d' => '流水线用户数',
            'pipeline_pipecount_d' => '当前流水线条数',
            'pipeline_executecount_d' => '流水线执行次数',
            'pipeline_elapse_time_d' => '流水线执行时长',
            'codecheck_usercount_d' => '代码检查用户数',
            'codecheck_taskcount_d' => '当前检查任务数',
            'codecheck_codelinecount_d' => '检查代码行数',
            'codecheck_issuecount_d' => '检查发现问题总数',
            'codecheck_execount_d' => '检查次数',
            'codeci_usercount_d' => '编译构建用户数',
            'codeci_buildcount_d' => '当前构建任务数',
            'codeci_allbuildcount_d' => '构建次数',
            'codeci_buildtotaltime_d' => '构建时长',
            'testman_usercount_d' => '测试管理用户数',
            'testman_casecount_d' => '用例总数',
            'testman_totalexecasecount_d' => '用例执行次数',
            'deploy_usercount_d' => '部署用户数',
            'deploy_envcount_d' => '当前部署任务数',
            'deploy_execount_d' => '部署次数',
            'deploy_vmcount_d' => '节点数',
        ];
    }

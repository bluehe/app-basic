...
//            'deploy_vmcount' => '节点数',
            ...
            'releaseman_uploadcount' => '发布上传数',
            'releaseman_downloadcount' => '发布下载数',
            ],
        'column_data'=>[
            'devcloud_pv_d' => 'PV（软开页面访问频次）(A)',
            
            'projectman_projectcount_d' => '当前项目数(A)',
            'projectman_membercount_d' => '当前项目成员数(A)',            
            'projectman_issuecount_d' => '工作项数(A)',
            'projectman_wiki_d' => '项目管理Wiki数(A)',
            'projectman_docman_d' => '项目管理文档数(A)',         
...
//            'projectman_storagecount_d' => '项目存储空间(A)',
            ...
            'codehub_repositorysize_d' => '代码仓库存储空间（M）(A)',
//            'codehub_all_usercount_d' => '配置管理用户数(A)',
            
            'pipeline_assignmentscount_d' => '流水线任务数(A)',
            'pipeline_elapse_time_d' => '流水线执行时长（分钟）(A)',
...
//            'deploy_vmcount_d' => '节点数(A)',
            ...
            'releaseman_uploadcount_d' => '发布上传数(A)',
            'releaseman_downloadcount_d' => '发布下载数(A)',
        ]
    ];

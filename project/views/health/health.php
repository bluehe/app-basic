...
$this->title = '健康度统计';
$this->params['breadcrumbs'][] = ['label' => '健康度', 'url' => ['health']];
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="pull-right header">
                    <?= count(UserGroup::get_user_groupid(Yii::$app->user->identity->id))>1?Select2::widget([
                        ...
                        'pluginEvents' => [
                            "change" => "function(start,end,label) {var v=$('.range-value').val();var g=$('#group').length?$('#group').val():''; self.location='".Url::to(['health'])."?range='+v+'&group='+g;}",
                        ]
                    ]):'';?>
...
//                        'endInputOptions' => ['value' => '2017-07-20'],
                        ...
                        'pluginEvents' => [
                            "apply.daterangepicker" => "function(start,end,label) {var v=$('.range-value').val();var g=$('#group').length?$('#group').val():'';allocate=$('.allocate').is(':checked')?1:0; self.location='".Url::to(['health'])."?range='+v+'&group='+g+'&allocate='+allocate;}",
                    ]
                    ]);
                    ?>
                </li>
...
//                            'size' => 'mini'
                        ...
                        'pluginEvents' => [
                            'switchChange.bootstrapSwitch' => "function(start,end,label) {var v=$('.range-value').val();var g=$('#group').length?$('#group').val():'';allocate=$('.allocate').is(':checked')?1:0; self.location='".Url::to(['health'])."?range='+v+'&group='+g+'&allocate='+allocate;}",
                    ]
                    ]);
                    ?>
                </li>

        ...
        //            'train_address',
                    ...
                    'buttons' => [
                        ...
                        'end' => function($url, $model, $key) {
                                    return in_array($model->train_stat,[Train::STAT_ORDER, Train::STAT_END])&&in_array(Yii::$app->user->identity->id,TrainUser::get_userid($model->id,'sa'))?Html::a(($model->train_stat==Train::STAT_END?'<i class="fa fa-pencil"></i> 变更':'<i class="fa fa-hand-peace-o"></i> 完成'), ['#'], ['data-toggle' => 'modal', 'data-target' => '#train-modal','class' => 'btn btn-warning btn-xs train-end',]):'';
                        },

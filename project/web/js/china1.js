(function (d, c) {
    if (typeof define === "function" && define.amd) {
        define(["exports", "echarts"], c)
    } else {
        if (typeof exports === "object" && typeof exports.nodeName !== "string") {
            c(exports, require("echarts"))
        } else {
            c({}, d.echarts)
        }
    }
    ...
    if (!d) {
        f("ECharts is not Loaded");
        return
    }
    if (!d.registerMap) {
        f("ECharts Map is not loaded");
        return
    }
    d.registerMap("china1", {

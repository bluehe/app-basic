...
class UserLevel extends \yii\db\ActiveRecord {
    ...
    public static function get_tab_userlevel($num = '') {
        ...
        foreach ($query->each() as $user) {
            ...
            $data[] = ['id' => $user->id, 'title' => $user->nickname ? $user->nickname : $user->username, 'label' => 'Lv.' . $level, 'label_class' => 'icon_level_c' . ceil($level / Yii::$app->params['level_c']), 'img' => $user->avatar];
        }
        return $data;
    }
